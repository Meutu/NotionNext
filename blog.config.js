...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://www.notion.so/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://ocyuzhou.cv
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '鱼缸🦉', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK ||充斥着想象力与主观感受的个人博客，不喜勿喷 'https://tangly1024.com', // 网站地址
